...
namespace PelmeniCompilers.ShiftReduceParser;
    ...
    where TSpan : IMerge<TSpan>, new()
{
    ...
    private readonly PushdownPrefixState<State> StateStack = new();
    ...
    /// </summary>
    protected bool YYRecovering { get; private set; }
    ...
    private void Reduce(int ruleNumber)
    {
        ...
        var rhLen = rule.RightHandSide.Length;
        //
        ...
        else if (rhLen == 0)
        {
            ...
            CurrentLocationSpan = Scanner.yylloc != null && LastSpan != null ? Scanner.yylloc.Merge(LastSpan) : default;
        }
        else
        {
            // Default action: $$ = $1;
    ...
    private bool ErrorRecovery()
    {
        ...
        if (!YYRecovering) // if not recovering from previous error
            ReportError();
    ...
    private bool DiscardInvalidTokens()
    {
        ...
        if (YYRecovering && tokensSinceLastError == 0)
        {
            // 
...
#pragma warning restore 649
    ...
    {
        get => default; // Empty implementation allowing
        set
        {
            /* skip */
...
#endif
{
    ...
    internal void Push(T value)
    {
        if (Depth >= array.Length)
        {
            ...
            Array.Copy(array, newarray, Depth);
            array = newarray;
        }
